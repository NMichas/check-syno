...
public class MemoryInfo extends OIDGetter {
  ...
  public static List<MibResult> get(Snmp snmp, CommunityTarget communityTarget) throws
    ...
    retVal.add(new MibResult("Memory - total swap space",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.4.3.0"))));
    retVal.add(new MibResult("Memory - swap space unused",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.4.4.0"))));
    retVal.add(new MibResult("Memory - physical total",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.4.5.0"))));
    retVal.add(new MibResult("Memory - physical unused",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.4.6.0"))));
    retVal.add(new MibResult("Memory - free",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.4.11.0"))));
    retVal.add(new MibResult("Memory - allocated",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.4.13.0"))));
