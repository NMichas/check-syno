...
public class CPUInfo extends OIDGetter {
  ...
  public static List<MibResult> get(Snmp snmp, CommunityTarget communityTarget) throws
    ...
    retVal.add(new MibResult("CPU load 5m",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.10.1.5.2"))));
    retVal.add(new MibResult("CPU load 15m",
        Long.parseLong(getSingleOID(snmp, communityTarget, ".1.3.6.1.4.1.2021.10.1.5.3"))));
